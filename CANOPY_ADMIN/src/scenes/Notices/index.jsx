...
const Team = () => {
  ...
  const handleDelete = (id) => {
    axios.delete(`http://localhost:4500/admin/notice/${id}`).then(() => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch("http://localhost:4500/admin/canopy_notice");
  ...
  return (
    <Box m="20px">
      <Header 
  title="NOTICES"
  subtitle="Get to View All Notices"
  style={{ color: "aqua" }}
