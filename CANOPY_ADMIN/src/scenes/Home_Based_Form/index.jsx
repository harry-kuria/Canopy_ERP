...
const handleCloseSnackbar = (event, reason) => {
  ...
  const handleClick = async (e) => {
    ...
    try {
      ...
      const response = await Axios.post('http://18.191.22.39:5000/facilities/signup', formData);
  ...
  return (
    <Box m="20px">
      <Header title="CREATE HOME-BASED-CARE CENTRES" subtitle="Create a New Home-based Centre Profile" />
