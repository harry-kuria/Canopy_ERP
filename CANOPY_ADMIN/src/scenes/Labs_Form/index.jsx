...
const handleCloseSnackbar = (event, reason) => {
  ...
  const handleClick = async (e) => {
    ...
    try {
      ...
      const response = await Axios.post('http://18.191.22.39:5000/lab_and_diagnostics/signup', formData);
  ...
  return (
    <Box m="20px">
      <Header title="CREATE HOSPITALS" subtitle="Create a New Hospital Profile" />
