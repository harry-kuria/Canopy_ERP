...
router.get('/',(req, res, next)=>{
    const sqlSelect = "SELECT * FROM blood_banks"; 
...
router.post('/add',upload.single('photoURL'),(req, res, next)=>{
    ...
    const sqlInsert = 'INSERT INTO blood_banks (photoURL, facilityname, facilityaddress, contact,email,services,bed_capacity) VALUES (?,?,?,?,?,?,?);';
...
router.delete('/:facilityId', (req, res, next) => {
    ...
    const sql = `DELETE FROM blood_banks WHERE id = ${id}`;
