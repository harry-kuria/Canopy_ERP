...
router.get('/',(req, res, next)=>{
    const sqlSelect = "SELECT * FROM pharmacies"; 
...
router.delete('/:facilityId', (req, res, next) => {
    ...
    const sql = `DELETE FROM pharmacies WHERE id = ${id}`;
...
router.post('/add',upload.single('photoURL'),(req, res, next)=>{
    ...
    const sqlInsert = 'INSERT INTO pharmacies (photoURL, facilityname, facilityaddress, contact,email,services,bed_capacity) VALUES (?,?,?,?,?,?,?);';
