...
router.post('/signup',upload.single('photoURL'), (req, res, next)=> {
    ...
    const sqlInsert = 'INSERT INTO doctors (first_name, last_name, email, password, contact, speciality, brief_speciality, verified, regnumber, photourl,academics,professional,certification,bio,insurance,gender,approved) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?);';
    pool.query(sqlInsert,[ first_name,last_name,email, password, contact, speciality,brief_speciality,verified,regnumber, "","","","","","","","" ], (error, results) =>{
      ...
      let mailOptions = {
          ...
          to: email,
          subject: 'Dear Dr. '+first_name+' '+last_name,
