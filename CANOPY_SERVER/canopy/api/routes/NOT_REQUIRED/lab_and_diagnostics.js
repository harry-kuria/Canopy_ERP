...
router.get('/',(req, res, next)=>{
    const sqlSelect = "SELECT * FROM lab_and_diagnostics"; 
...
router.post('/add',upload.single('photoURL'),(req, res, next)=>{
    ...
    const sqlInsert = 'INSERT INTO lab_and_diagnostics (photoURL, facilityname, facilityaddress, contact,email,services,bed_capacity) VALUES (?,?,?,?,?,?,?);';
